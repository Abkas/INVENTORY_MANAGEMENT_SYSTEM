...
if (!isset($_GET['id'])) {
    header("Location: /INVENTORY_SYSTEM/BACKEND/staff.php");
    exit();
}
...
<div class="container">
    ...
    <div class="main-content">
        <div class="header">
            <div>
                <a href="/INVENTORY_SYSTEM/BACKEND/staff.php" style="text-decoration:none; color:var(--text-sub); display:inline-flex; align-items:center; gap:4px; font-size:0.9rem; margin-bottom:4px;">
